...
//   char MYFILE[] = "dchi2_emu_IH_5+5_mu+e.dat"; 
  char MYFILE[] = "Prob_NOvA_NH_MINOS_matter.dat"; 
  ...
  // 5+5(mu+e)
//   glbInitExperiment("DUNE_GLoBES_5+5_mu+e.glb", &glb_experiment_list[0], &glb_num_of_exps);

  // 5+5(mu+tau)
  glbInitExperiment("2024_nova_app.glb", &glb_experiment_list[0], &glb_num_of_exps);
  //glbInitExperiment("DUNE_GLoBES_tau_5+5_mu+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);

  // 5+5+1+1(mu+tau)
//   glbInitExperiment("DUNE_GLoBES_5+5+1+1_mu+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);
//   glbInitExperiment("DUNE_GLoBES_tau_5+5+1+1_mu+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);

  // 5+5(mu+e+tau)
//   glbInitExperiment("DUNE_GLoBES_5+5_mu+e+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);
//   glbInitExperiment("DUNE_GLoBES_tau_5+5_mu+e+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);

  // 5+5+1+1(mu+e+tau)
  // glbInitExperiment("DUNE_GLoBES_5+5+1+1_mu+e+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);
  // glbInitExperiment("DUNE_GLoBES_tau_5+5+1+1_mu+e+tau.glb", &glb_experiment_list[0], &glb_num_of_exps);
  ...
  double true_dcp = 0.82 * M_PI ;

  // IH true, NH test
  double true_theta12 = 0.63;
  double true_theta13 = 0.152;
  double true_theta23 = 0.84;
  double true_sdm = 7.74e-5; // dm21
  double true_ldm = 2.53e-3; // dm32
  ...
  //glbSetDensityParams(test_values, 1.0, GLB_ALL);
    ...
    glbSetRates();
double e, p, q, r, s;
  for(e=0.01;e<=14;e+=.01)
  {
   
 
    
    
p=glbConstantDensityProbability(2,1, +1, e, 753.3, 2.8);
q=glbConstantDensityProbability(2,2, +1, e, 753.3, 2.8);
r=glbConstantDensityProbability(2,3, +1, e, 753.3, 2.8);
